...
# @raycast.title Reply with AI (ChatGPT)
# @raycast.mode silent
# @raycast.icon 💬
...
# Delegate to ChatGPT launcher which copies the composed prompt and opens ChatGPT
node ./chatgpt.js "$email_content" "$instructions" "$recipient_name"

echo "Prepared reply context for ChatGPT (prompt copied and sent if possible)."
